...
export const home = {
  ...
  together: {
    ...
    cards: [
      { title: `Wake with a friend`, body: `Mit Freunden aufwachen: Du schickst einen Link; das Telefon der anderen Person baut den Alarm lokal. Jede Seite behält ihre eigene Kopie, deine Änderungen greifen also nicht in ihre ein.` },
  ...
  pricing: {
    ...
    free: {
      ...
      features: [
        ...
        `Wake with a friend und die Uhren-App für beide Handgelenke`,
