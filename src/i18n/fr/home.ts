...
export const home = {
  ...
  together: {
    ...
    cards: [
      { title: `Wake with a friend`, body: `Réveillez-vous avec un ami : vous envoyez un lien ; le téléphone d’en face construit l’alarme en local. Chacun garde sa propre copie, donc modifier la vôtre ne touche pas la sienne.` },
  ...
  pricing: {
    ...
    free: {
      ...
      features: [
        ...
        `Wake with a friend, et l’application de montre aux deux poignets`,
