...
So for [the first stretch of every morning](/blog/first-30-minutes-brain-after-waking), you are, quite literally, operating without your executive functions fully online. Your eyes are open. The CEO hasn't arrived yet.
...
4. **Cognitive load, on purpose.** The prefrontal cortex is the last region to wake, and it responds to being *used*. [Working memory tasks](/blog/math-alarm-science-solving-beats-snoozing) (arithmetic, recall, sequencing) force blood flow and activation into exactly the circuitry that's lagging. It's the difference between waiting for the engine to warm up and actually driving.
