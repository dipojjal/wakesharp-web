...
In 2002, researchers led by Thomas Balkin used PET imaging to watch brains in the act of waking up. The result is one of the most useful facts you'll ever learn about your mornings: consciousness comes back fast, but *alertness* doesn't. Brainstem and thalamus — the deep machinery that makes you conscious at all — reactivate within minutes. The **prefrontal cortex**, the region responsible for planning, judgement, working memory and self-control, takes another 20 to 30 minutes to catch up ([Balkin et al., *Brain*, 2002](https://pubmed.ncbi.nlm.nih.gov/12244087/)).
...
![Illustration of a brain in profile, half wrapped in night-time darkness with stars, the front half glowing in warm sunrise colors.](../../assets/blog/sleep-inertia-why-you-wake-up-groggy/inline-1.jpg)
...
1. **Light, immediately.** Bright, short-wavelength light after waking speeds the recovery of alertness — researchers have measured it after both natural and simulated dawn ([Sleep, 2022](https://pmc.ncbi.nlm.nih.gov/articles/PMC9787581/)). Open the curtains before you open your inbox; outside beats every bulb you own.
...
![Illustration of a refreshed person stretching at a bright open window in the morning, with a bird on the sill and coffee steaming on the desk.](../../assets/blog/sleep-inertia-why-you-wake-up-groggy/inline-2.jpg)
...
And the honest limits, because we'd rather say them than have you discover them: no app deletes sleep inertia — it's your biology doing its job. Short sleep will still buy you a longer fog, missions or not. And no alarm on any phone is beyond your phone's own settings and battery, which is why WakeSharp checks alarm reliability the night before and tells you plainly — it will ring, it may not, or it cannot — instead of showing a comforting green tick it can't back up.
